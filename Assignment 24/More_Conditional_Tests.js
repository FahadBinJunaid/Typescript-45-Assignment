...
console.log("Inequality with strings:", "Banana" != "orange");
...
console.log("tests involving inequality:", 50 != 30);
// // greater than:
...
console.log("Tests using or operators:", 18 != 15 || false);
// //Test whether an item is in a array:
const countrysName = ["pakistan", "USA", "china"];
...
console.log("\nnow false tests:\n");
//Tests for equality and inequality with strings:
console.log("Equality test with strings:", "Blue" === "Red");
//Tests for inequality with strings:
console.log("Inequality with strings:", "Yellow" != "Yellow");
//Tests using the lower case function:
console.log("using the lower case function:", "HOW ARE YOU".toLowerCase() === "HOW ARE YOU");
//Numerical tests involving equality and inequality: greater than and less than, greater than or equal to, and less than or equal to
//Numerical tests involving equality:
console.log("Numerical tests involving equality:", 85 === 20);
//tests involving inequality:
console.log("tests involving inequality:", 250 != 250);
// greater than:
...
// Tests using "and" and "or" operators:
//Tests using "and" operators:
console.log("Tests using and operators:", 90 === 50 && 100 > 258);
//Tests using "or" operators:
console.log("Tests using or operators:", 44 != 44 || false);
// //Test whether an item is in a array:
const countryNames = ["pakistan", "USA", "china"];
